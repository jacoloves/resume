...
| 名前                                                        | 言語       | スター数 |
| ----------------------------------------------------------- | ---------- | -------- |
| [vim-ChangeLog](https://github.com/jacoloves/vim-ChangeLog) | Vim script | 5        |
| [easy-template](https://github.com/jacoloves/easy-template) | Rust       | 2        |
| [GirlFriend](https://github.com/jacoloves/GirlFriend)       | C#         | 1        |

### 副業

#### プログラミングスクールのメンター(2020/05〜2020/12)

- 役割:
  - web アプリケーション制作のスケジュール管理、
  - 生徒が実施した PHP や Laravel の課題の疑問点を回答
- 使用技術:
  - PHP
  - Laravel
  - Git
...
- アプリの設計や実装をフロント〜インフラまで横断的にやっていきたい。
- IaC やインフラの自動化をするためのコードが好きなので、今後もその分野に挑戦していきたいです。
- インフラエンジニアとしてもっと設計・構築に携わることができる環境で働きたいです。
- インフラエンジニアとしてはまだ未熟なので、技術力を高めるためにもっと学びたいです。

## 希望条件

### 必須

- 現在の会社で長時間労働とパワハラで悩んでいるので、ワークライフバランスを大切にしている企業で働きたいです（繁忙期での長時間労働は応相談）
- クライアントファーストをモットーにしている企業では働きたくないです。（長時間労働の温床になるので）
- 客先常駐は避けたいです。

### できれば

- フルリモート or リモートワークでの勤務を希望します
- インフラエンジニアとしてのキャリアを積むために、インフラの設計・構築に携わることができる環境で働きたいです
- 新しく技術を学ぶことができる環境で働きたいです
